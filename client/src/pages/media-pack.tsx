...
export default function MediaPack() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero */}
      <section
        className="text-white py-16 border-b border-border"
        style={{
      ...
      >
        <div className="max-w-[1296px] mx-auto px-6">
          <div className="max-w-[640px]">
            ...
            <p style={{ fontFamily: "Georgia, serif", fontSize: 18, lineHeight: 1.7, color: "rgba(255,255,255,0.85)", fontStyle: "italic" }}>
